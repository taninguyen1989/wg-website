                        ...
                        <div className="relative z-10 max-w-2xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <button
                                    ...
                                    className="group inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-primary-dark to-primary-light text-white rounded-full font-medium hover:brightness-110 transition-all transform hover:-translate-y-1 shadow-xl shadow-primary/25"
                                >
                                    {t.ctaPrimary}
