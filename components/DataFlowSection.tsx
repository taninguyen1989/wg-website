...
import { Brain, FileText, Server, Workflow, Zap } from "lucide-react";
                            ...
                            <div className="relative flex flex-col items-center text-center">
                                <div className="relative mb-6">
                                    <div className="size-24 bg-white rounded-full shadow-xl flex items-center justify-center border-4 border-gray-50 z-10 relative">
                                        <Server className="size-10 text-gray-700" />
                                    </div>
                                    <div className="absolute inset-0 bg-blue-100 rounded-full animate-ping opacity-20" />
                                    <div className="absolute -right-12 top-10 hidden md:block">
